...
Practical reference for the current tool-migration state in `packages/nous`.
...
Tool tests should use the existing Effect helpers in `packages/nous/test/lib/effect.ts`:
