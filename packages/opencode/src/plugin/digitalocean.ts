import type { Hooks, PluginInput } from "@nous-ai/plugin"
import type { Model } from "@nous-ai/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Nous - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to Nous."
