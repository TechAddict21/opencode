...
- PR #15835: https://github.com/anomalyco/nous/pull/15835

## Do Not Translate (Locale Additions)

- `OpenCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `nous` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenCode` in prose, `nous` only for exact technical identifiers
...
- Avoid changing `nous` to `OpenCode` inside commands, URLs, package names, or code literals
