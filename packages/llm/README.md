...
Schema-first LLM core for nous. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@nous-ai/llm"
import { OpenAI } from "@nous-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@nous-ai/llm/providers"
