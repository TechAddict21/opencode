import { Slug } from "@nous-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@nous-ai/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@nous-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".noussh", "plans")
