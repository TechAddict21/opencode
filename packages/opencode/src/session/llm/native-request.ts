import type { JsonSchema, LLMRequest, ProviderMetadata } from "@nous-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@nous-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @nous-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
