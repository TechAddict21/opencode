...
import { tool as nativeTool, ToolFailure, type JsonSchema, type LLMEvent } from "@nous-ai/llm"
import type { LLMClientShape } from "@nous-ai/llm/route"
...
export function stream(input: StreamInput): StreamResult {
  ...
  // Integration point with @nous-ai/llm: native-request lowers session data
