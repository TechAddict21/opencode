...
The nous server has moved to the Effect HttpApi backend. Remaining work is
...
- plugins get global "nous" instance like in that post i showed
- nous instance has stuff like `nous.session.prompt()` or
  `nous.tool.register({...})`
