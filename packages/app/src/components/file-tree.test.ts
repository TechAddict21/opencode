...
beforeAll(async () => {
  ...
  mock.module("@nous-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nous-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nous-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nous-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
